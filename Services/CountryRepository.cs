...
namespace BookApiProject.Services
{
    public class CountryRepository : ICountryRepository
    {
        ...
        public CountryRepository(BookDbContext contryContext)
        {
            _countryContext = contryContext;
        }

        public bool AuthorExists(int authorId)
        {
            return _countryContext.Authors.Any(a => a.Id == authorId);
        }
        ...
        public ICollection<Author> GetAuthorsFromAnCountry(int countryId)
        {

            ...
            var booksAuthors = new List<BookAuthor>()
            {
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        {
                            new Review { Headline = "Awesome Book", ReviewText = "Reviewing Call of the Wild and it is awesome " +
                            "movie i am amazed and thi movie left me beyond word", Rating = 5,
                            Reviewer = new Reviewer() { FirstName = "John", LastName = "Smith"} },

                            new Review { Headline = "Terrible Book", ReviewText = "Reviewing Call of the Wild and it is " +
                            "terrible book", Rating = 1,
                            Reviewer = new Reviewer() { FirstName = "Peter", LastName = "Griffin" } },

                            new Review { Headline = "Decent Book", ReviewText = "Not a bad read, I kind of lige it", Rating =4,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Western Book", ReviewText = "Reviewing Winnetou and it is " +
                            "awesome book", Rating = 4,
                            Reviewer = new Reviewer(){ FirstName = "Frank", LastName = "Lampard" } }
                        }
                    },
                    Author = new Author()
                    {
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Programming Book", ReviewText = "Revieving Pavols Best" +
                            "Book and it is awome beyond words", Rating = 5,
                            Reviewer = new Reviewer(){FirstName = "Pavol2", LastName = "Almas12"}}
                        }
                    },
                    Author = new Author()
                    {
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Good Romantic Book", ReviewText = "This book made me cry a few times",
                            Rating = 5,
                            Reviewer = new Reviewer() { FirstName = "Kayle", LastName = "Kutz"} },
                            new Review { Headline = "Horrible Romantic Book", ReviewText = "My wife made me read it" +
                            "and hated it :)", Rating = 1,
